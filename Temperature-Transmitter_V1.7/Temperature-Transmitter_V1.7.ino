...
int16_t tmpr=TempC*10+1000;

//Исходя из реалий максимально-возможной температуры воздуха на планете Земля 
//ограничиваем максимальную температуру для передачи +99,9 °C
if(tmpr>1999){tmpr=1999;}

//ФОРМИРУЕМ ПАКЕТ ДАННЫХ ДЛЯ ПЕРЕДАЧИ
String strMsg="TX1";//Сигнатура-идентификатор конкретного датчика (3 любых символа)
strMsg+=tmpr;//Добавляем в строку "strMsg" температуру (3 или максимум 4 знака)
...
if(tmpr-1000<0){Serial.print('-');}else{Serial.print('+');}
Serial.print(whole);Serial.print(',');Serial.println(fract);
Serial.println();Serial.println();Serial.println();Serial.println();
#endif


Timer_LED=millis();digitalWrite(LED_INFO_PIN,HIGH);//Зажигаем светодиод для индикации
