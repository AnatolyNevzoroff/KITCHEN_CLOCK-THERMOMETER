...
//МАЛЕНЬКИЙ ШРИФТ 3Х5 
const uint8_t font3x5[11][5] PROGMEM ={//11 массивов по 5 элементов в каждом
...
int16_t MaxTemp=-999,MinTemp=999;//Начальные значения невозможных предельных температур
...
FL_START_MENU=true;//Поднимаем флаг для запуска начального режима работы
