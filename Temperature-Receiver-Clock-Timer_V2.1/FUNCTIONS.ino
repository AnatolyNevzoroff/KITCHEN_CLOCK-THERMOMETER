...
switch (Temperature){
  case 100 ... 999: //Для температуры в диапазоне от 99,9 до 10,0
symb3x7(3, 0,9);//Знак "+"
...
symb3x7(2, 5,9);//Знак "-"
  break;
  case -550 ... -100: //Для температуры в диапазоне от -10,0 до -55,0
symb3x7(2, 0,9);//Знак "-"
symb4x7(whole/10, 5,9);//Первый разряд градусов
  break;
}//Конец манипуляций
...
symb5x7(1, 0,9);
switch (MinTemp){
  case 100 ... 999:   symb3x7(3, 8,9);symb4x7(whole/10, 13,9);break;
  ...
  case -550 ... -100: symb3x7(2, 8,9);symb4x7(whole/10, 13,9);break;
}
